...
export const BRAND_CATALOG: readonly CatalogBrand[] = [
  ...
  { token: 'okta', name: 'Okta', domains: ['okta.com', 'oktapreview.com', 'okta-emea.com'] },
  { token: 'auth0', name: 'Auth0', domains: ['auth0.com'] },
  { token: 'duo', name: 'Duo Security', domains: ['duo.com', 'duosecurity.com'] },
